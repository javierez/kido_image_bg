...
if __name__ == "__main__":
    ...
    test_prompt = "Professional marketing photo of a diverse group of elementary school students with white features engaged in collaborative learning activities in a bright modern classroom. The children, aged 9-11, are gathered around a shared project table, some pointing at their work while others lean in to contribute ideas, with natural, relaxed expressions that convey genuine happiness and engagement. Some students are taking notes while others are manipulating learning materials, creating an authentic scene of peer interaction. Natural daylight creates a warm and inviting atmosphere, while maintaining a clean, uncluttered composition with soft white background. The scene captures their youthful enthusiasm and teamwork without any cultural props or stereotypical elements. Photorealistic, high-end production quality, perfect for marketing."

    test_prompt = """Fotografía profesional de alta calidad y resolución fotorrealista de una ventana antigua de madera natural sin ornamentos con un cristal fino.
    La escena captura una ventana con un desgaste elegante y un atractivo estético nostálgico.
    En el marco de la ventana de madera oscurecida nacen unas pocas y delicadas flores secas con eucalipto, creando una composición bella pero con un aire de tristeza contenida.
    La iluminación es escasa, tenue, creando un ambiente íntimo y atmosférico con tonos predominantemente marrón-grisáceos, marrones profundos y ocres apagados.
    La composición debe mantener un estilo minimalista pero cautivador, con un enfoque selectivo que resalte la belleza melancólica y la poética del paso del tiempo.
    Protagonista es la ventana, no las flores, que deben ser un detalle de la composición."""

    test_prompt = """Fotografía profesional de alta calidad y realista de algo inerte, nostálgico, 
    delicado y abandonado. Estilo minimalista y sombrío"""
